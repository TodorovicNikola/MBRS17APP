namespace WebApplication1.Migrations
{
    ...
    public partial class init : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Naziv_PDV_a = c.String(nullable: false, maxLength: 128, unicode: false),
                    })
                .PrimaryKey(t => t.Id)
                .Index(t => t.Naziv_PDV_a);
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Naziv = c.String(nullable: false, maxLength: 128, unicode: false),
                        Oznaka = c.String(nullable: false, maxLength: 128, unicode: false),
                    })
                .PrimaryKey(t => t.Id)
                .Index(t => t.Naziv)
                .Index(t => t.Oznaka, unique: true);
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Naziv = c.String(nullable: false, maxLength: 128, unicode: false),
                        Postanski_broj = c.String(nullable: false, maxLength: 128, unicode: false),
                    })
                .PrimaryKey(t => t.Id)
                .Index(t => t.Naziv)
                .Index(t => t.Postanski_broj, unique: true);
        ...
        public override void Down()
        {
            ...
            DropIndex("dbo.Mesto", new[] { "Postanski_broj" });
            DropIndex("dbo.Mesto", new[] { "Naziv" });
            DropIndex("dbo.Stavka_dokumenta", new[] { "Roba_ID" });
            DropIndex("dbo.Jedinica_mere", new[] { "Oznaka" });
            ...
            DropIndex("dbo.Poslovni_partner", new[] { "Naziv" });
            ...
            DropIndex("dbo.Magacin", new[] { "Naziv" });
